...
컬럼: id, word, pinyin, masking, pos, type, meaning, en_meaning, tip, tts_type, tts_voice, img_path, video_path, sound_path.
...
def _rows_from_words_dataframe(df: DataFrame) -> list[dict[str, Any]]:
    ...
    for _, row in df.iterrows():
        ...
        rows.append({
            ...
            "tts_type": _normalize(row.get("tts_type", row.get("tts", ""))).lower(),
